...
⚠ **이걸 띄운 채로 `pytest` 를 돌리지 말 것.** 실포트(50001/6550/1460)를 잡고 있으면 전체 스위트가
멈춘다 — 15분이 넘게 무반응이고 CPU 는 거의 0 이라 느린 것처럼 보이지도 않는다
(2026-09-07 두 번 겪음, 내린 뒤엔 26초에 끝난다). 어느 테스트가 막힐지는 아직 모른다.
