...
oneport_cmdset = {
    ...
    "LP": [
        "Local port number",
        r"^([0-9]|[1-9][0-9]{1,3}|[1-5][0-9]{4}|6[0-4][0-9][0-9][0-9]|65[0-4][0-9][0-9]|655[0-2][0-9]|6553[0-5])$",
        {},
        "RW",
    ],
    "RH": [
    ...
    "DB": ["UART Data bit length", r"^[0-1]$", {"0": "7-bit", "1": "8-bit"}, "RW"],
    "PR": ["UART Parity bit", r"^[0-2]$", {"0": "NONE", "1": "ODD", "2": "EVEN"}, "RW"],
    "SB": ["UART Stop bit length", r"^[0-1]$", {"0": "1-bit", "1": "2-bit"}, "RW"],
    "FL": [
        "UART Flow Control",
        r"^[0-4]$",
    ...
    "PS": ["Size Delimiter", r"^([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])$", {}, "RW"],
    # "PD" : ["Char Delimiter", "^([0-7][0-9a-fA-F])$", {}, "RW"],
    "PD": ["Char Delimiter", r"^([0-9a-fA-F][0-9a-fA-F])$", {}, "RW"],
    "IT": [
    ...
    "CP": ["Connection Password Enable", r"^[0-1]$", {}, "RW"],
    "NP": ["Connection Password", "", {}, "RW"],
    "SP": ["Search ID Code", "", {}, "RW"],
    # "DG" : ["Serial Debug Message Enable", "^[0-1]$", {}, "RW"],
    # debug msg test
    "DG": ["Serial Debug Message Enable", r"^[0-4]$", {}, "RW"],
    "KA": ["TCP Keep-alive Enable", r"^[0-1]$", {}, "RW"],
    "KI": [
    ...
    "EC": ["Serial Command Echoback Enable", r"^[0-1]$", {}, "RW"],
    "TE": ["Command mode Switch Code Enable", r"^[0-1]$", {}, "RW"],
    "SS": ["Command mode Switch Code", r"^(([0-9a-fA-F][0-9a-fA-F]){3})$", {}, "RW"],
    ...
    "GA": ["Status and Value of User I/O pin A", r"^[0-1]$", {"0": "Low", "1": "High"}, "RW"],
    "GB": ["Status and Value of User I/O pin B", r"^[0-1]$", {"0": "Low", "1": "High"}, "RW"],
    "GC": ["Status and Value of User I/O pin C", r"^[0-1]$", {"0": "Low", "1": "High"}, "RW"],
    "GD": ["Status and Value of User I/O pin D", r"^[0-1]$", {"0": "Low", "1": "High"}, "RW"],
    "SC": [
...
wiz2000_added_cmdset = {
    ...
    "SE": ["SSL/TLS 1.2 enable", r"^[0-1]$", {}, "RW"],
    "CE": ["Cloud connection enable", r"^[0-1]$", {}, "RW"],
    ...
    "LF": ["Local Port Fix for channel 0 (TCP client only)", r"^[0-1]$", {}, "RW"],
    "QF": ["Local Port Fix for channel 1 (TCP client only)", r"^[0-1]$", {}, "RW"],
    "AE": ["Setting Password Enable", r"^[0-1]$", {}, "RW"],
    ...
    "CS": [
        ...
        r"^([1-9][0-9] | [1-9][0-9][0-9] | [1-2][0-9][0-9][0-9] | 3[0-6]00 )$",
        {},
        "RW",
    ],
    "CM": ["Cloud Monitor Enable", r"^[0-4]$", {}, "RW"],
...
wiz510ssl_added_cmdset = {
    ...
    "GR": ["Device Group", "", {}, "RW"],
    # ----------------------------------------------
    "RC": ["Root CA Option", r"^[0-2]$", {}, "RW"],
    "CE": ["Client Certificate Enable", r"^[0-1]$", {}, "RW"],
    "OP": [
    ...
    "QK": ["MQTT options - Keep Alive", r"^([0-9]|[1-9][0-9]{1,3}|[1-5][0-9]{4}|6[0-4][0-9][0-9][0-9]|65[0-4][0-9][0-9]|655[0-2][0-9]|6553[0-5])$", {}, "RW"],
