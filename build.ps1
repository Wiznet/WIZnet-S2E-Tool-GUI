...
uv run python -m PyInstaller -w -F -n $target_bin_name --add-data ".\\gui\\*;.\\gui" --add-data ".\\version;.\\" --add-data ".\\config\\*.yaml;.\\config" --add-data ".\\config\\*.json;.\\config" --add-data ".\\specs;.\\specs" .\main_gui.py
