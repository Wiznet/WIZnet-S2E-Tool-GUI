...
WIZ5XX_RP_CMDSET = {
    **common_cmdset,
    ...
    "SZ": ["UDP packet size", "^[0-9]{6}$", {}, "RW"],     #사이즈 추가가 필요한 모델의 경우 SZ를 다 추가해야함.
    ...
    "U3": ["MQTT Subscribe topic 4", "", {}, "RW"],
    "U4": ["MQTT Subscribe topic 5", "", {}, "RW"],
    "U5": ["MQTT Subscribe topic 6", "", {}, "RW"],
    "U6": ["MQTT Subscribe topic 7", "", {}, "RW"],
    "U7": ["MQTT Subscribe topic 8", "", {}, "RW"],
    "U8": ["MQTT Subscribe topic 9", "", {}, "RW"],
    "U9": ["MQTT Subscribe topic 10", "", {}, "RW"],
