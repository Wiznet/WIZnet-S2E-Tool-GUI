...
class WIZ2000CMDSET:
    def __init__(self, log_level):
        ...
        self.cmdset = {
            ...
            "OP": [
                "Network Operation Mode for channel 0",
                "^[0-3]$",
                {"0": "TCP Client mode", "1": "TCP Server mode", "2": "TCP Mixed mode", "3": "UDP mode"},
                "RW",
            ],
            "QO": [
                "Network Operation Mode for channel 1",
                "^[0-3]$",
                {"0": "TCP Client mode", "1": "TCP Server mode", "2": "TCP Mixed mode", "3": "UDP mode"},
                "RW",
            ],
            ...
            "LP": [
                "Local port number for channel 0",
                "^([0-9]|[1-9][0-9]{1,3}|[1-5][0-9]{4}|6[0-4][0-9][0-9][0-9]|65[0-4][0-9][0-9]|655[0-2][0-9]|6553[0-5])$",
                {},
                "RW",
            ],
            "QL": [
                "Local port number for channel 1",
                "^([0-9]|[1-9][0-9]{1,3}|[1-5][0-9]{4}|6[0-4][0-9][0-9][0-9]|65[0-4][0-9][0-9]|655[0-2][0-9]|6553[0-5])$",
                {},
                "RW",
            ],
            "RH": [
                "Remote Host IP address for channel 0",
                "^(([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])\.){3}([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])$",
                {},
                "RW",
            ],
            "QH": [
                "Remote Host IP address for channel 1",
                "^(([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])\.){3}([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])$",
                {},
                "RW",
            ],
            "RP": [
                "Remote Host Port number for channel 0",
                "^([0-9]|[1-9][0-9]{1,3}|[1-5][0-9]{4}|6[0-4][0-9][0-9][0-9]|65[0-4][0-9][0-9]|655[0-2][0-9]|6553[0-5])$",
                {},
                "RW",
            ],
            "QP": [
                "Remote Host Port number for channel 1",
                "^([0-9]|[1-9][0-9]{1,3}|[1-5][0-9]{4}|6[0-4][0-9][0-9][0-9]|65[0-4][0-9][0-9]|655[0-2][0-9]|6553[0-5])$",
                {},
                "RW",
            ],
            "BR": [
                "UART channel 0 Baud rate",
                "^([0-9]|1[0-3])$",
                {
                    "0": "300",
                    "1": "600",
            ...
            "PT": [
                "Time Delimiter for channel 0",
                "^([0-9]|[1-9][0-9]{1,3}|[1-5][0-9]{4}|6[0-4][0-9][0-9][0-9]|65[0-4][0-9][0-9]|655[0-2][0-9]|6553[0-5])$",
                {},
                "RW",
            ],
            "NT": [
                "Time Delimiter for channel 1",
                "^([0-9]|[1-9][0-9]{1,3}|[1-5][0-9]{4}|6[0-4][0-9][0-9][0-9]|65[0-4][0-9][0-9]|655[0-2][0-9]|6553[0-5])$",
                {},
                "RW",
            ],
            ...
            "IT": [
                "Inactivity Timer Value for channel 0",
                "^([0-9]|[1-9][0-9]{1,3}|[1-5][0-9]{4}|6[0-4][0-9][0-9][0-9]|65[0-4][0-9][0-9]|655[0-2][0-9]|6553[0-5])$",
                {},
                "RW",
            ],
            "RV": [
                "Inactivity Timer Value for channel 1",
                "^([0-9]|[1-9][0-9]{1,3}|[1-5][0-9]{4}|6[0-4][0-9][0-9][0-9]|65[0-4][0-9][0-9]|655[0-2][0-9]|6553[0-5])$",
                {},
                "RW",
            ],
            ...
            "KI": [
                "TCP Keep-alive Initial Interval for channel 0",
                "^([0-9]|[1-9][0-9]{1,3}|[1-5][0-9]{4}|6[0-4][0-9][0-9][0-9]|65[0-4][0-9][0-9]|655[0-2][0-9]|6553[0-5])$",
                {},
                "RW",
            ],
            "RS": [
                "TCP Keep-alive Initial Interval for channel 1",
                "^([0-9]|[1-9][0-9]{1,3}|[1-5][0-9]{4}|6[0-4][0-9][0-9][0-9]|65[0-4][0-9][0-9]|655[0-2][0-9]|6553[0-5])$",
                {},
                "RW",
            ],
            "KE": [
                "TCP Keep-alive Retry Interval for channel 0",
                "^([0-9]|[1-9][0-9]{1,3}|[1-5][0-9]{4}|6[0-4][0-9][0-9][0-9]|65[0-4][0-9][0-9]|655[0-2][0-9]|6553[0-5])$",
                {},
                "RW",
            ],
            "RE": [
                "TCP Keep-alive Retry Interval for channel 1",
                "^([0-9]|[1-9][0-9]{1,3}|[1-5][0-9]{4}|6[0-4][0-9][0-9][0-9]|65[0-4][0-9][0-9]|655[0-2][0-9]|6553[0-5])$",
                {},
                "RW",
            ],
            "RI": [
                "TCP Reconnection Interval for channel 0",
                "^([0-9]|[1-9][0-9]{1,3}|[1-5][0-9]{4}|6[0-4][0-9][0-9][0-9]|65[0-4][0-9][0-9]|655[0-2][0-9]|6553[0-5])$",
                {},
                "RW",
            ],
            "RR": [
                "TCP Reconnection Interval for channel 1",
                "^([0-9]|[1-9][0-9]{1,3}|[1-5][0-9]{4}|6[0-4][0-9][0-9][0-9]|65[0-4][0-9][0-9]|655[0-2][0-9]|6553[0-5])$",
                {},
                "RW",
            ],
            ...
            "E0": [
                "Status of pin E0 (PHY Link or DTR)",
                "^[0-1]$",
                {
                    "0": "PHY Link Up / The device != ready",
                    "1": "PHY Link Down / The device ready for communication",
            ...
            "E1": [
                "Status of pin E1 (TCP Connection or DST)",
                "^[0-1]$",
                {
                    "0": "PHY Link Up / The device != ready",
                    "1": "PHY Link Down / The device ready for communication",
...
if __name__ == "__main__":
    cmdsetObj = WIZ2000CMDSET(logging.DEBUG)
