...
class WIZ2000CMDSET:
	def __init__(self, log_level):
		...
		self.cmdset = { "MC" : ["MAC address", 
                            ...
                            "AL" : ["Device Alias", "", {}, "RW"], 
                            "GR" : ["Device Group", "", {}, "RW"], 
                            "AM" : ["TCP Connection Auto Message", "^[0-6]$",
                                    {"0":"None", "1":"Device Name", "2":"Mac Address", "3":"IP Address", "4":"Device ID(type+mac)", "5":"Device Alias", "6":"Device Group"},
                                    "RW"], 
                            "CS" : ["Cloud Monitor Update Interval", "^([1-9][0-9] | [1-9][0-9][0-9] | [1-2][0-9][0-9][0-9] | 3[0-6]00 )$", {}, "RW"], 
